...
exports.getTenantQueries = exports.getTenantBasicQuery = void 0;
const getTenantBasicQuery = (tenantIdentifier) => {
    return `query {
            tenant {
...
exports.getTenantBasicQuery = getTenantBasicQuery;
const getTenantQueries = (tenantId) => {
    return {
        vatTypes: `query {
        tenant {
          get(id: "${tenantId}") {
...
exports.getTenantQueries = getTenantQueries;
//# sourceMappingURL=createSpecQuery.js.map